...
function prestige_get_default($field_id)
{
    $defaults = array(
        ...
        // Hakkımızda Defaults
        'prestige_about_hero_title' => 'YAŞAM ALANLARINI <br /> <span class="italic text-primary/90">YENİDEN TANIMLIYORUZ</span>',
        'prestige_about_hero_desc' => '2021\'den bu yana Adana\'da prestijli rezidans ve villa projeleriyle modern yaşamın konforunu sunuyoruz.',
        'prestige_about_story_title' => 'Capital Yaşam Hikayesi',
        'prestige_about_story_content' => '2021 yılında Adana\'da kurulan Capital Yaşam İnşaat, Sarıçam ve Çukurova bölgelerinde prestijli rezidans ve villa projeleri geliştirmektedir. Kaliteli malzeme, modern mimari ve müşteri memnuniyeti odaklı yaklaşımımızla, her projemizde yaşam standartlarını yükselten mekanlar inşa ediyoruz.',
        'prestige_about_story_image' => '',
        // Kurumsal Defaults
        'prestige_corp_hero_title' => 'MİSYON <br /> <span class="italic text-primary/90">& VİZYON</span>',
        'prestige_corp_hero_desc' => 'Güven, kalite ve yenilikçilik temelleri üzerine kurulu kurumsal kimliğimiz.',
        'prestige_corp_profile' => 'Capital Yaşam İnşaat, Adana\'nın Sarıçam ve Çukurova bölgelerinde modern rezidans ve villa projeleri geliştiren, müşteri memnuniyetini ön planda tutan bir inşaat firmasıdır. 2021\'den bu yana kaliteli yaşam alanları sunmaktayız.',
        'prestige_corp_policy' => 'Tavizsiz kalite anlayışımız ve güvenilir iş süreçlerimizle, her projede müşterilerimize en yüksek değeri sunmayı taahhüt ediyoruz.',
        // Logo Defaults
